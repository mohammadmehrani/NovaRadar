...
var defaultSources = []IPSource{
	...
	{ID: "as13335", Name: "AS13335", URL: "https://raw.githubusercontent.com/ipverse/asn-ip/master/as/13335/ipv4-aggregated.txt", Type: SourceCIDR, Enabled: false},
	{ID: "as209242", Name: "AS209242", URL: "https://raw.githubusercontent.com/ipverse/asn-ip/master/as/209242/ipv4-aggregated.txt", Type: SourceCIDR, Enabled: false},
	{ID: "as24429", Name: "AS24429", URL: "https://raw.githubusercontent.com/ipverse/asn-ip/master/as/24429/ipv4-aggregated.txt", Type: SourceCIDR, Enabled: false},
	{ID: "as199524", Name: "AS199524", URL: "https://raw.githubusercontent.com/ipverse/asn-ip/master/as/199524/ipv4-aggregated.txt", Type: SourceCIDR, Enabled: false},
...
var allSources = defaultSources

func fetchIPsFromJSON(sourcesJSON string) (cidrs []string, directIPs []string) {
	enabled := parseEnabledSources(sourcesJSON)
	var mu sync.Mutex
...
func parseEnabledSources(json string) map[string]bool {
